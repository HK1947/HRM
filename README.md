...
Playwright HTML, JSON and Allure reports are generated by the configured reporters. CI uploads the Playwright report and test results as workflow artifacts so failures can be investigated with traces, screenshots and logs.
